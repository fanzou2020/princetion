...
public class HexDump {
    ...
    /**
     * Reads in a sequence fo bytes from standard input and wirtes them to
     * standard output using hexadecimal notation, k hex digits per line,
     * where k is given as a command-line integer (defaults to 16 if no integer
     * is specified); also writes the number of bits
    ...
    public static void main(String[] args) {
        ...
        for (i = 0; !BinaryStdIn.isEmpty(); i++) {
            ...
            else if (i % bytesPerLine == 0) StdOut.println();
            else StdOut.print(" ");
